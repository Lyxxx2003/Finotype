...
export default function StartPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 font-sans bg-gradient-morandi">
      <div className="w-full max-w-md space-y-8 rounded-3xl backdrop-blur-xl border p-10" style={{ background: 'rgba(255,255,255,0.9)', borderColor: 'var(--color-neutral-200)', boxShadow: '0 20px 40px rgba(42,38,34,0.12)' }}>
        <div>
          <div className="mx-auto w-16 h-16 bg-gradient-morandi-blue rounded-2xl flex items-center justify-center mb-6 shadow-lg">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleStart}>
          ...
          <div>
            <button
              type="submit"
              disabled={!name.trim()}
              className="btn-morandi-primary w-full disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {t('startButton')}
            </button>
          </div>
